...
<script>
      ...
      "columns":[
        ...
        {data: "student_id",
          render:function (data,type,row) {
            return '<button type="button" onclick="showModal('+data+')" class="btn btn-outline-info">View</button>'+ ' <button type="button" onclick="generate('+data+')" class="btn btn-outline-warning">Generate Report</button>'
          }}
      ],
    });
  }
  ...
  function generate(id){
    window.open("generate_grade.php?student_id="+id+"&creation_date="+getDateToday()+"&key=generate")
  }
</script>
</html>
