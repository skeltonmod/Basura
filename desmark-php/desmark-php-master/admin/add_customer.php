  ...
  <div class="card" style="margin-top: 2em; margin-bottom: 2em">
    ...
    <div class="card-body">
      <form id="form" enctype="multipart/form-data">
         ...
         <div class="form-group col-md-4">
           ...
           <div class="input-group mb-2">
             <div class="input-group-prepend">
               <div class="input-group-text"><a id="customerId">CUST-</a></div>
             </div>
        ...
        <div class="form-group">
          <label for="frmCtrlImage">Add ID Picture</label>
          <input type="file" class="form-control-file" id="frmCtrlImage">
        </div>

        <div class="form-group">
          <label for="frmCtrlFile">Add NSO Certificate</label>
...
<script>
  $(document).ready(function () {
    $("#accountCode").val(Math.floor(Math.random() * 1000).toString());
  })
function insertData(){
  alert("insertdata")
  ...
  let image_file = $("#frmCtrlImage")[0].files[0]
  let document_file = $("#frmCtrlFile")[0].files[0]
  formData.append("accountname",accountName)
  formData.append("gender",gender)
  formData.append("civil_status",civil_status)
  formData.append("image_file",image_file)
  formData.append("document",document_file)
  formData.append("key","insertCustomer")
